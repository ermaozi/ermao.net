---
url: /blog/weekly-news-2026-08-27/index.md
description: >-
  本周关注 Qwen3.8 开放权重、WhatsApp 账号安全升级、Kiro AI 代理数据外传路径、ChatGPT 印度广告、DeepSeek
  周末价格，以及地震预警和食品安全调查的证据边界。
---
...
![2026 年 8 月 21 日至 27 日国内热点与科技周报封面，主题为 AI 可用性、账号与代理安全、公共预警 =1600x900 =1600x900](https://image.ermao.net/images/blog/weekly-news-2026-08-27/20260828_091506-296dd7.svg)
...
Qwen 团队 8 月 26 日发布 Qwen3.8-Flash-Next。官方和 [IT 之家当日报道](https://m.ithome.com/html/994735.htm)都指向同一组基本数字：主模型参数量 125B，另有 51B 的 N-gram embedding，每 token 激活 6B 参数。原生上下文长度是 262,144 tokens，官方称可通过 YaRN 扩展至 100 万 tokens。
...
![Qwen3.8-Flash-Next 开放权重与 API 可用性对比卡 =1600x900 =1600x900](https://image.ermao.net/images/blog/weekly-news-2026-08-27/20260828_090255-46a95a.svg)
...
Mindgard 在 8 月 27 日的实质更新中披露了 Kiro Powers 路径。研究方表示，在 Kiro IDE 0.7.45 上，攻击者控制的仓库内容可影响代理，让它读取敏感数据、修改工作区 URL，并发起携带秘密的外部请求。[Mindgard 研究页](https://mindgard.ai/blog/amazon-kiro-data-exfiltration)和 [The Hacker News 报道](https://thehackernews.com/2026/08/amazon-kiro-prompt-injection-can.html)支持这条演示链，但没有公布广泛利用证据。
...
[TechCrunch 8 月 27 日报道](https://techcrunch.com/2026/08/27/openai-to-start-showing-ads-on-chatgpts-free-and-go-tiers-in-india/)，OpenAI 将在印度的 ChatGPT Free 和 Go 套餐中展示广告，首批涉及 50 个品牌，并计划下月推出广告管理器。这一项目只有一家可信媒体的当日报道，本轮没有找到对应的 OpenAI 官方公告，所以全部细节应保留“据报道”边界。
...
[DeepSeek 官方计费页](https://api-docs.deepseek.com/quick_start/pricing/) 8 月 22 日更新，新规则自北京时间 8 月 23 日零时起执行：周六和周日全天使用低谷价；工作日的 9:00–12:00 和 14:00–18:00 仍为高峰，其余时段为低谷。这不是又一次简单降价，而是把周期性调度放进计费规则。

![DeepSeek API 周末低谷计费时段解释卡 =1600x900 =1600x900](https://image.ermao.net/images/blog/weekly-news-2026-08-27/20260828_090255-015206.svg)
...
如果你正在开发工具中使用 DeepSeek，本站的 [VS Code 接入 DeepSeek V4 指南](/blog/vscode-deepseek-v4/) 可以作为配置参考，但它不是计费保证，也不代替当日官方价格页。本期可确认的是周末新规则已生效；未来单价、时段和资源容量都可能再次变动。

## 一周热点雷达：一条错误预警和一次全国专项排查

### 4.7、5.4 和 7.7 级：误差与授权错链是两个问题

8 月 24 日，部分手机和手表弹出四川长宁 7.7 级地震预警。[四川省地震局通报的央广网转载](https://news.cnr.cn/native/gd/20260824/t20260824_527789270.shtml)说明，官方最终测定为 4.7 级，官方预警估算为 5.4 级。发出 7.7 级信息的成都高新减灾研究所，在 7 月 22 日已被终止第三方授权，但仍以相关名义向多类终端推送信息。

![四川长宁地震官方测定、预警估算与错误推送对比卡 =1600x900 =1600x900](https://image.ermao.net/images/blog/weekly-news-2026-08-27/20260828_090313-b1d749.svg)
...
8 月 23 日，[央视新闻报道的三部门处置口径](https://finance.eastmoney.com/a/202608233850362523.html)表示，康保县对“白菜收购环节蘸取甲醛溶液”视频的初查确认情况属实，公安部门已对相关人员、车辆采取强制措施。三部门要求追查流向，并对白菜等易腐蔬菜开展专项抽检。
...
8 月 24 日，[Solidot 引介](https://www.solidot.org/story?sid=85179)了一个尚未定案的时间计量构想：10 月的国际计量大会将讨论用“闰时”取代频繁的闰秒，把地球自转造成的累积差异留到几百年后，再一次调整一小时。
...
1. **WhatsApp 用户：** 检查“设置→账号”中的两步验证和通行密钥，用唯一密码替换弱 PIN，清理不再使用的设备。入口缺失可能是分批上线，不要通过陌生链接安装所谓“提前版”。
2. **AI 开发者：** 试用 Qwen 时分开记录权重可用性、硬件需求、自有数据集结果和未上线 API 的限制；不把厂商 benchmark 当成自己业务结果。
3. **AI 代理用户：** 陌生仓库先用无真实密钥的隔离环境阅读，限制文件范围和出站网络，在工具调用前查看完整参数。
4. **API 成本管理：** 只把可延迟、可重试的批处理放到 DeepSeek 周末低谷，并用小批次对账，不要为了单价牺牲在线业务时效。
5. **紧急预警和食品事件：** 先做不增加现场风险的防护，再从官方渠道核对；区分初查、抽检、追流向和最终处罚，不用网传数字扩大结论。
...
1. [Qwen Team：Qwen3.8-Flash-Next](https://qwen.ai/blog?id=qwen3.8-flash-next)，2026-08-26，官方发布。
2. [IT 之家：阿里通义 Qwen3.8-Flash（Next）发布开源](https://m.ithome.com/html/994735.htm)，2026-08-26，独立报道。
3. [Meta：New Account Security Features for WhatsApp](https://about.fb.com/news/2026/08/new-account-security-features-for-whatsapp/)，2026-08-25，官方新闻稿与头图来源。
4. [The Hacker News：WhatsApp Adds Multiple Passkeys](https://thehackernews.com/2026/08/whatsapp-adds-multiple-passkeys-for.html)，2026-08-25，独立安全报道。
5. [Mindgard：Power Leak — Amazon Kiro IDE Prompt Injection Enables Data Exfiltration](https://mindgard.ai/blog/amazon-kiro-data-exfiltration)，2026-08-27 实质更新，安全研究披露。
6. [The Hacker News：Amazon Kiro Prompt Injection Can Exfiltrate Sensitive Data Through Kiro Powers](https://thehackernews.com/2026/08/amazon-kiro-prompt-injection-can.html)，2026-08-27，独立报道。
7. [TechCrunch：OpenAI to Start Showing Ads on ChatGPT's Free and Go Tiers in India](https://techcrunch.com/2026/08/27/openai-to-start-showing-ads-on-chatgpts-free-and-go-tiers-in-india/)，2026-08-27，媒体报道，未得到官方公告交叉验证。
8. [DeepSeek：API 模型与计费规则](https://api-docs.deepseek.com/quick_start/pricing/)，2026-08-22 更新，官方计费页。
9. [四川省地震局通报（央广网转载）](https://news.cnr.cn/native/gd/20260824/t20260824_527789270.shtml)，2026-08-24，主要通报来源。
10. [央视新闻：三部门指导地方快速处置“白菜收购环节蘸取甲醛溶液”问题](https://finance.eastmoney.com/a/202608233850362523.html)，2026-08-23，三部门处置口径。
11. [Solidot：国际计量大会将讨论用闰时取代闰秒](https://www.solidot.org/story?sid=85179)，2026-08-24，轻松项与解释性线索。

## 相关阅读

* [VS Code 接入 DeepSeek V4](/blog/vscode-deepseek-v4/)
* [上一期国内热点与科技周报](/blog/weekly-news-2026-08-20/)
