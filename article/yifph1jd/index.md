---
url: /article/yifph1jd/index.md
description: >-
  据媒体报导，2022届高校毕业生规模预计达1076万人，同比增加167万人，再创历史新高。
  如此大规模的毕业生涌入人才市场，企业该如何消化呢？又有什么办法能够降低就业难度呢？
  以我拙见，这并非老板需要考虑的问题，而是需要我们在职社畜来进行努力。努力的方向也很简单：停止内卷、投身摸鱼事业，降低单人工作量以增加就业岗...
---
据媒体报导，2022届高校毕业生规模预计达1076万人，同比增加167万人，再创历史新高。
...
![使用Vim上班看小说 示例图片 =999x164](https://image.ermao.net/images/article/yifph1jd/image.png)

点这个gvimxx.exe进行下载

下载完成后直接打开，有的时候电脑比较敏感，会提示有风险。其实没啥风险。点击更多信息里面的仍要安装就可以了。

![使用Vim上班看小说 示例图片 =532x495](https://image.ermao.net/images/article/yifph1jd/image-1.png)

![使用Vim上班看小说 示例图片 =527x484](https://image.ermao.net/images/article/yifph1jd/image-2.png)
...
![使用Vim上班看小说 示例图片 =335x621](https://image.ermao.net/images/article/yifph1jd/image-3.png)

复制刚刚打开的目录路径

![使用Vim上班看小说 示例图片 =634x208](https://image.ermao.net/images/article/yifph1jd/image-4.png)

按 win 键，输入“环境变量”并点击“编辑系统环境变量”

![使用Vim上班看小说 示例图片 =717x634](https://image.ermao.net/images/article/yifph1jd/image-5.png)

依次进行：点击“环境变量” – 双击“Path” – 双击空白处 – 粘贴前面复制的 vim 目录路径 – 一路点击“确定”

![使用Vim上班看小说 示例图片 =1024x446](https://image.ermao.net/images/article/yifph1jd/image-6.png)

按 win 键，输入“powershell” 并按回车进入 powershell。

在 powershell 中执行“vim –version”检查一下是否安装成功了吧！

![使用Vim上班看小说 示例图片 =751x205](https://image.ermao.net/images/article/yifph1jd/image-7.png)
...
![使用Vim上班看小说 示例图片 =1024x697](https://image.ermao.net/images/article/yifph1jd/image-8.png)
...
![使用Vim上班看小说 示例图片 =918x326](https://image.ermao.net/images/article/yifph1jd/image-9.png)

效果是这样

![使用Vim上班看小说 示例图片 =1024x644](https://image.ermao.net/images/article/yifph1jd/image-10.png)
...
![使用Vim上班看小说 示例图片 =890x164](https://image.ermao.net/images/article/yifph1jd/image-11.png)
...
![使用Vim上班看小说 示例图片 =767x345](https://image.ermao.net/images/article/yifph1jd/image-12.png)

`rn -l` 可以列出该目录中的所有小说，如果没有小说则会提示。

![使用Vim上班看小说 示例图片 =664x363](https://image.ermao.net/images/article/yifph1jd/image-13.png)

`rn -s 小说名`可以设置默认小说

![使用Vim上班看小说 示例图片 =756x148](https://image.ermao.net/images/article/yifph1jd/image-14.png)
