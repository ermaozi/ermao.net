...
![ipwhois 节点信息](https://image.ermao.net/article/r50bpg9j/image.png)

然后直接让 AI 来判断，这样更快更准确。

![deepseek 判断节点线路类型](https://image.ermao.net/article/r50bpg9j/image-1.png)

![deepseek 判断节点线路类型](https://image.ermao.net/article/r50bpg9j/image-2.png)
