...
![极搜机器人](https://image.ermao.net/article/rsvptr5x/image.png)

## 获取推广链接

先输入`/pc`呼出推广数据菜单。点击`邀请赚钱`。

![极搜机器人](https://image.ermao.net/article/rsvptr5x/image-1.png)

点击复制[专属分享链接](https://t.me/jisou?start=a_1453425105)后就可以把这个链接分享给别人了。

![极搜机器人](https://image.ermao.net/article/rsvptr5x/image-2.png)

## 推广奖励

![极搜机器人](https://image.ermao.net/article/rsvptr5x/image-3.png)
...
![极搜机器人](https://image.ermao.net/article/rsvptr5x/image-4.png)

然后点击`立即提现`

![极搜机器人](https://image.ermao.net/article/rsvptr5x/image-5.png)

点击`UT钱包`

![极搜机器人](https://image.ermao.net/article/rsvptr5x/image-6.png)

回复提现金额后就可以完成提现了。要注意的是不满50刀无法提现。

![极搜机器人](https://image.ermao.net/article/rsvptr5x/image-7.png)
...
![UT钱包](https://image.ermao.net/article/rsvptr5x/image-8.png)
