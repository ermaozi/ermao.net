---
title: Install Clash Verge on Windows, Linux, and macOS
createTime: 2024/10/23 12:21:37
permalink: /en/article/0gematwc/
lang: en-US
translationOf: /article/0gematwc/
tags:
  ...
  - macOS
  - Clash Verge
description: Install Clash Verge on Windows, macOS, or Linux, import a subscription, enable service and TUN modes, set the system proxy, and test nodes.
---
...
![Clash Verge subscription-import screen](https://image.ermao.net/images/article/0gematwc/image.png)
...
![Imported subscription in the profile list](https://image.ermao.net/images/article/0gematwc/image-1.png)
...
![Editing the subscription name, URL, and update interval](https://image.ermao.net/images/article/0gematwc/image-2.png)

Right-click and select **Edit Profile** to change the update interval, URL, or name.

![Enabling service mode and TUN mode](https://image.ermao.net/images/article/0gematwc/image-3.png)
...
![Confirming Rule mode on the Proxies page](https://image.ermao.net/images/article/0gematwc/image-4.png)

Finally, open **Proxies** and confirm that the mode is set to **Rule**.

## Test the connection

![Clash Verge latency and connectivity test](https://image.ermao.net/images/article/0gematwc/image-5.png)
