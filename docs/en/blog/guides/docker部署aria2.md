...
tags:
  ...
  - Docker
  - WebSocket
title: Deploy aria2 with Docker and Use WebSocket RPC
permalink: /en/article/b06gglcq/
description: Deploy Aria2 Pro in Docker, connect a browser controller over authenticated WebSocket RPC, and configure a TLS reverse proxy without exposing RPC openly.
lang: en-US
translationOf: /article/b06gglcq/
---
