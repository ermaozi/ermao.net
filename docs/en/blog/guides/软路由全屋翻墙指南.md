---
title: OpenWrt Side-Router Guide for a Whole-Home Proxy (2026)
createTime: '2026/02/19 01:42:48'
permalink: /en/blog/softrouter/
lang: en-US
translationOf: /blog/softrouter/
description: Plan an OpenWrt main-router or side-router setup, secure the device, configure IPv4 and IPv6 deliberately, add a proxy client, and test failover and DNS.
head:
  - - link
    - rel: canonical
      href: https://www.ermao.net/en/blog/softrouter/
  - - meta
    - name: keywords
      content: OpenWrt router proxy, side router, whole-home proxy, OpenClash, PassWall, gateway configuration
tags:
  - OpenWrt
  - side router
  - home network
...
![Reader question about routing an Apple TV](https://image.ermao.net/images/blog/softrouter/image.png)
...
![NanoPi R4S-style OpenWrt device](https://image.ermao.net/images/blog/softrouter/image-1.png)
