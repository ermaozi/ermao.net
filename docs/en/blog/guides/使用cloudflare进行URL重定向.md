---
title: Redirect an Old Domain with Cloudflare
createTime: '2024/08/31 21:12:45'
permalink: /en/article/jqtuqouj/
lang: en-US
translationOf: /article/jqtuqouj/
tags:
  - Cloudflare
  - URL redirect
  - WordPress
  - GitHub Pages
  - site migration
description: Create a Cloudflare Single Redirect that moves old hostnames to a new site with a permanent status, preserved paths, and optional query strings.
---
...
![Cloudflare DNS records for the old hostnames](https://image.ermao.net/images/article/jqtuqouj/image.png)
...
![Opening Redirect Rules in Cloudflare](https://image.ermao.net/images/article/jqtuqouj/image-1.png)

In the Cloudflare dashboard, open **Rules → Redirect Rules**, then choose **Create rule → Redirect Rule**.

![Configuring the hostname and dynamic target](https://image.ermao.net/images/article/jqtuqouj/image-2.png)
