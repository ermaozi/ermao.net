---
title: Run OpenWrt as a Side-Router VM on FNOS
createTime: 2025/11/20 05:41:43
permalink: /en/blog/fnoswrt/
tags:
  - FNOS
  - OpenWrt
  - Side router
  - Virtual machine
  - NAS
description: Create an OpenWrt x86-64 VM on FNOS, attach it safely to the LAN, assign a non-conflicting static address, disable competing DHCP, and test client routing.
lang: en-US
translationOf: /blog/fnoswrt/
---
