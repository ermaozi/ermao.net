---
title: Back Up FNOS Files to OneDrive with Docker
createTime: '2025/01/06 12:15:17'
permalink: /en/article/aofygutj/
tags:
  - FNOS
  - Docker
  - OneDrive
  - Backup
  - NAS
description: Deploy the maintained Linux OneDrive client in Docker on FNOS, authorize it as a non-root user, choose two-way or archive-style behavior, and test restores.
lang: en-US
translationOf: /article/aofygutj/
---
